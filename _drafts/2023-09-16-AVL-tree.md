...
1. 当该结点的左子树比右子树高，且左结点的左子树比右子树高，此时只要进行一次右旋操作即可，我们记为 LLRotation，如图：  

    ![avltree_llrotation.png]({{ site.baseurl }}/styles/images/algorithm/avltree/avltree_llrotation.png)  
...
2. 与 1 镜像操作，当该结点的右子树比左子树高，且右结点的右子树比左子树高，此时只需要进行一次左旋操作即可，我们记为 RRRotation，如图：  

    ![avltree_rrrotation.png]({{ site.baseurl }}/styles/images/algorithm/avltree/avltree_rrrotation.png)  
